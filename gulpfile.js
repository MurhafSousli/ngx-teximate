...
const LIBRARY_NAME = 'ng-teximate';
...
gulp.task('package', (cb) => {
    ...
    targetPkgJson['main'] = `bundles/ng-teximate.umd.js`;
...
gulp.task('bundle', () => {
    ...
    const rollupGenerateOptions = {
        ...
        moduleId: '',
        moduleName: 'ngTeximate', //require for 'umd' bundling, must be a valid js identifier, see rollup/rollup/issues/584
        format: 'umd',
        globals,
        dest: 'ng-teximate.umd.js'
    };
...
// Link 'dist' folder (create a local 'ng-teximate' package that symlinks to it)
// This way, we can have the demo project declare a dependency on 'ng-teximate' (as it should)
// and, thanks to 'npm link ng-teximate' on demo project, be sure to always use the latest built
